...
$(document).ready(function() {
	...
	var switchery = new Switchery(elemsingle, { color: '#2ed8b6', jackColor: '#fff' ,size: 'small'});

	var elemsingle2 = document.querySelector('.js-single2');
	var switchery = new Switchery(elemsingle2, { color: '#2ed8b6', jackColor: '#fff' ,size: 'small'});
