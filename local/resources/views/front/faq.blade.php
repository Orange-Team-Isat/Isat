                                ...
                                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-heading" role="tab" id="headingOne">
                                            <div class="row">
                                                <div class="col-10">Applying for a teaching job</div>
                                                <div class="col-2">
                                        ...
                                        <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                                            <div class="panel-body">
                                                <h6>Answer :</h6>
                                                <p>International Schools Association of Thailand (ISAT) is an association that keeps the international schools in Thailand informed about the government laws, professional development opportunities and what’s happening here in Thailand. In our website, you will find list of schools in Thailand with their websites. You can go through them and inquire directly for teaching job vacancies.</p>
                                            </div>
                                        </div>
