      ...
      <div class="col-md-12">
        <div class="card">
            <div class="card-header card_head_modify">
                <div class="row">
                    <div class="col-md-8">
                        <span class="pull-left pt-1" style="font-size: 18px;">ข้อมูลสมาชิก</span>
                    </div>
                    
                    <div class="col-md-4">
                        <div class="pull-right pt-1">
                            <a href="{{ url('managemember/create') }}">
                                <button class="btn btn-primary btn-mini btn-round waves-effect waves-light mt-1"><i class="fa fa-plus-circle"></i>เพิ่มข้อมูลสมาชิก</button>
                            </a>
                        </div> 
                    </div>
                </div>
